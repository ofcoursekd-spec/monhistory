      ...
      {status === 'failed' && (
        <>
          ...
          <p className="text-ink/60 mt-2">
            Le webhook GeniusPay n&apos;a pas encore confirmé la transaction. Cela peut prendre
            quelques minutes. Reviens vérifier plus tard sur ton profil.
          </p>
...
function Fallback() {
  return (
    <section className="mx-auto max-w-md px-4 py-20 text-center">
      <div className="mx-auto h-12 w-12 rounded-full border-4 border-brand/20 border-t-brand animate-spin" />
      <h1 className="font-display text-2xl font-bold mt-6">Chargement…</h1>
    </section>
  );
}
